...
IMAGE_SYSTEM_PROMPT = """You are a medical assistant specialized in breast imaging and radiology.
    ...
    - Reference specific features (shape, margin, sphericity, and posterior acoustic behavior) in your reasoning
    - Ground your prediction strictly in the BI-RADS guidelines provided in the context
    - Be precise and clinical in your language
    - Structure your response as a single cohesive rationale followed by the BI-RADS category — avoid repeating the same reasoning twice
...
def ask(user_question, vector_store, client, image_path=None):
    ...
    if image_path:
        ...
        posterior_features = extract_posterior_features(image_path)
